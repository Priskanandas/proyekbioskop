...
Route::resource('admin-upcoming','UpcomingController'); //Route Menu Admin Film


Route::get('/user_home','FilmController@show_film')->name('user_home'); //Route menampilkan film pada *user_home*
Route::get('/nowplaying','FilmController@show_film')->name('nowplaying'); //Route menampilkan film pada *user_home*
Route::get('/upcoming','UpcomingController@show_upcoming')->name('upcoming'); //Route menampilkan film pada *user_home*
...
Route::get('/upcoming/{upcoming_id}','DetUpcomingController@index');
...
Route::resource('admin','UserController'); //Route Menu Admin Member
//Route::delete('/admin-delete', [UserController::class, 'destroy'])->name('admin.delete');
//Route::resource('admin', UserController::class)->except(['destroy']);
//Route::delete('/admin-delete', [UserController::class, 'destroy'])->name('admin.delete');
