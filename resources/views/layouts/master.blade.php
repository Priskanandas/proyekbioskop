...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo">
      ...
      <span class="logo-lg"><b>M</b>o<b>v</b>ies</span>
    </a>
...
<script src="{{asset('js/editUpcoming.js')}}"></script>
