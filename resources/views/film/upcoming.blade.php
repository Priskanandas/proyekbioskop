	...
	<div class="box" style="margin-left: 100px; margin-right:100px;">
		...
		@foreach($hasil as $data)
			<table class="table borderless">
				<tbody>
					<tr>
						<th scope="row" rowspan="8"><img class="img-fluid img-thumbnail rounded float-left" src="{{asset('upload/images/'.$data->image) }}" alt="" style="width: 300px; height: 300px;"></th>
					</tr>
					<tr>
						<td style="">Nama</td>
						<td>:</td>
	    		...
	    		<div class="col-6">
	    			...
	    			<div class="row">
				    		<div class="col-sm-4 ml-auto mr-auto">
					    		<button type="submit" class="btn btn-primary kursi" data-toggle="modal"  style="margin-bottom: 20px">COOMING SOON</button>
				    		</div>
