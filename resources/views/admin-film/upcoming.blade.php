...
@section('content')
	<div class="">
				    ...
				    <tbody>
				    	@foreach($listUpcoming as $list)
						    <tr>
								...
								<td>
							@if($list->image)
								<img src="{{ asset('upload/images/' . $list->image) }}" alt="Gambar {{ $list->name }}" style="max-width: 100px; height: auto;">
							@else
		...
		<!-- /.box-body -->
			<div class="box-footer clearfix">
				<!-- Tambah Film -->
				<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#UpcomingModal">
				  Add New Movie
				</button>
	...
	<!-- Modal -->
	<div class="modal fade" id="UpcomingModal" tabindex="-1" role="dialog" aria-labelledby="UpcomingModal">
	...
	<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="upcomingModal">Edit Movie</h4>
	      </div>
	      <form action="{{route('admin-upcoming.update','test')}}" method="post" enctype="multipart/form-data">
	      	{{method_field('patch')}}
	      	{{csrf_field()}}
	      	<div class="modal-body">
			<input type="hidden" name="id_upcoming" id="id_upcoming">
	        	@include('admin-film.form')
	      	</div>
	      	<div class="modal-footer">
	        	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
